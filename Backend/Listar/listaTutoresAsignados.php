...
$sql = "SELECT staffs.id_staff, staffs.id_card_number_staff, staffs.name_staff, staffs.firts_name_staff,
                ...
                teacher_tutor.id_grade1, teacher_tutor.id_section2, grades.grade, section.section
        ...
        WHERE staffs.id_profile_staff1 = '3' and staffs.status_staff = '1' and teacher_tutor.status_mentor = '1' ";
